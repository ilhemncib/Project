import Image from "../../flower-1.jpg";
      ...
      <div className="row mb-4">
        ...
        <div className="col-lg-5">
          <div className="d-flex flex-column h-100">
            <h2 className="mb-1"></h2>flower
            <h4 className="text-muted mb-4">100</h4>
            ...
            <dl className="row">
              ...
              <dd className="col-sm-8 mb-3">flower color </dd>

              <dt className="col-sm-4">Manufacturer</dt>
              <dd className="col-sm-8 mb-3">flower</dd>
            ...
            <p className="lead flex-shrink-0">
              <small>
              Très sentimental ; naïvement romantique. (Par extension) Naïf et rêveur. La fin du chapitre 63 d'Aurélien d'Aragon de Cécile Narjoux illustre un côté fleur bleue.
              </small>
            </p>
          </div>
        </div>
